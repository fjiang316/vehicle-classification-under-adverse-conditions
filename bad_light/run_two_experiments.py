...
PRETRAINED_MODELS = {
    ...
    'densenet': 'saved_models/densenet1.h5',
}

FINETUNED_MODELS = {
    'mobilenet_ft': 'finetuned_models/mobilenet_finetuned.h5',
    'inception_ft': 'finetuned_models/inception_finetuned.h5',
    'densenet_ft': 'finetuned_models/densenet_finetuned.h5',
}
...
def main():
    ...
    # COMPARISON
    # ========================================================================
    if pretrained_models and finetuned_models:
        print(f"\n\n{'='*70}")
